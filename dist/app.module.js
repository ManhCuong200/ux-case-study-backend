...
const screens_module_1 = require("./modules/screens/screens.module");
const hotspots_module_1 = require("./modules/hotspots/hotspots.module");
        ...
        imports: [
            ...
            typeorm_1.TypeOrmModule.forRootAsync({
                ...
                useFactory: (configService) => ({
                    ...
                    database: configService.get('DB_DATABASE') || 'ux_case_study',
